...
\justifying
    ...
    \\More accurate high-resolution forecasts support agriculture management, disaster preparedness, and climate resilience, benefiting communities and policymakers. \\\vspace{1cm}
    \textbf{Next steps}
    \\Further investigate specific regions for each season.
\end{frame}
